...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2025 at 03:48 PM
...
INSERT INTO `properties` (`property_id`, `user_id`, `title`, `description`, `address`, `city`, `zip_code`, `transaction`, `price`, `available_from`, `created_at`, `property_type_id`) VALUES
(1, 1, 'Modern Apartment in Belgrade', 'Modern apartment in the center of Belgrade with a great view.', 'Knez Mihailova 12', 'Belgrade', '11000', 'sale', 75000.00, '2025-07-15', '2025-02-01 06:00:00', 1),
(2, 2, 'Family House in Novi Sad', 'Charming house with three bedrooms and a large backyard.', 'Futoška 45', 'Novi Sad', '21000', 'sale', 45000.00, '2025-07-20', '2025-02-02 07:00:00', 2),
(3, 6, 'Luxury Studio for Rent', 'Furnished studio apartment with premium amenities.', 'Bulevar Oslobođenja 1', 'Niš', '18000', 'rent', 220.00, '2025-07-01', '2025-02-03 08:00:00', 3),
(4, 7, 'Spacious Family House', 'Large house with 4 bedrooms, a basement, and a garage.', 'Zmaj Jovina 10', 'Subotica', '24000', 'sale', 55000.00, '2025-08-01', '2025-02-04 09:00:00', 2),
(5, 10, 'Central Loft Apartment', 'Industrial-style loft with high ceilings and exposed brick.', 'Cara Dušana 202', 'Zrenjanin', '23000', 'rent', 350.00, '2025-07-10', '2025-02-05 10:00:00', 1),
(6, 1, 'Studio on the Danube River', 'Small but charming studio just steps from the Danube.', 'Dunavska 15', 'Sremska Mitrovica', '22000', 'rent', 180.00, '2025-07-05', '2025-02-06 11:00:00', 3),
(7, 2, 'Townhouse in Pančevo', 'Well-maintained house with access to pool and gym.', 'Vojvode Mišića 8', 'Pančevo', '26000', 'sale', 32000.00, '2025-08-15', '2025-02-07 12:00:00', 2),
(8, 6, 'Historic House in Sombor', 'Restored historic house with modern upgrades.', 'Trg Svetog Trojstva 5', 'Sombor', '25000', 'sale', 120000.00, '2025-09-01', '2025-02-08 13:00:00', 2),
(9, 7, 'New Build Apartment in Novi Sad', 'Luxury apartment with city view and concierge service.', 'Bulevar Evrope 7', 'Novi Sad', '21000', 'rent', 280.00, '2025-07-01', '2025-02-09 14:00:00', 1),
(10, 10, 'Ground Floor Apartment with Garden', 'Apartment with private garden in a quiet neighborhood.', 'Petefi Šandora 21', 'Senta', '24400', 'rent', 190.00, '2025-07-15', '2025-02-10 15:00:00', 1),
(15, 2, 'Spacious House in Novi Sad', 'Perfect family house close to the city center.', 'Futoška 88', 'Novi Sad', '21000', 'rent', 450.00, NULL, '2025-05-25 15:54:07', 2);
...
(15, 8, 'https://images.unsplash.com/photo-1572120360610-d971b9b6399e', 1),
(16, 8, 'https://images.pexels.com/photos/439391/pexels-photo-439391.jpeg', 0),
...
(14, 'rotetomi97123', 'tot.tamas04@gmail.com', '$2y$10$W4ctwmhScPj.3WQyARu2EewgVzSZmLo1a0PFHOWyJ33vvw1BU4Tq6', '06216216', 'user', '2025-07-05 14:56:21', 'Tamas', 'Tot', 1, 0, NULL, NULL, NULL, '2025-07-05 14:56:36');
...
--
ALTER TABLE `properties`
  MODIFY `property_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `property_images`
--
ALTER TABLE `property_images`
  MODIFY `image_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
